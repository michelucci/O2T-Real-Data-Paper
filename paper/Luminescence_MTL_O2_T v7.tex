...
To collect the large amount of data needed for the training, a fully automated setup was developed. After the definition of the range of interest a program varies the parameters of interest and acquires the corresponding sensor response. The hardware used for the sensor is standard laboratory equipment, which makes it easy to 

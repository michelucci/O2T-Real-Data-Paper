...
In the Result section we have also studied the prediction distribution of the $AE$s. To better illustrate this distribution, the kernel density estimate ($KDE$) of the $AE$s was also evaluated. Details on how this was calculated can be found in our previous paper \cite{Michelucci2019_2} and will not be repeated here.
%
%

...
\Author{Francesca Venturini$^{1,2}$*, Umberto Michelucci$^{1,3}$, Michael Baumgartner$^{2}$}
...
\address{%
$^{1}$ \quad TOELT LLC; Birchlenstr. 25, 8600 Dübendorf, Switzerland\\
$^{2}$ \quad Institute of Applied Mathematics and Physics, Zurich University of Applied Sciences,
